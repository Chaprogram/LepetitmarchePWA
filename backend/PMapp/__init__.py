...
import os
from PMapp import models  # Assure-toi que db est bien défini dans models.py, pas ici
from PMapp import db  # Utiliser l'import existant de db
...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv("DATABASE_URL", 'sqlite:///C:/Users/Moi/LepetitmarchePWA/backend/instance/site.db')  # Configuration de la base de données
